...
import com.client.app.commons.api.ApiError;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<Object> handelMetohBadException(Exception ex){
        ...
        return  buildResponseEntity(new ApiError(HttpStatus.BAD_REQUEST, ErrMsg.GENERIC_ERROR.getCode(), ErrMsg.GENERIC_ERROR.getMessage())); //asi si puede ser
    }
